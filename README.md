...
If you have a suggestion that would make this better, please fork the repo and create a Pull Request. You can also simply [open an issue](https://github.com/evertcode/hacktoberfest-issues-hunt-search.git/issues) with the tag *enhancement*.
