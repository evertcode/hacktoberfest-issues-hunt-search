  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen py-2'>
      ...
      <main className='flex flex-col w-full flex-1 py-2 px-2 md:px-10 overflow-x-hidden md:overflow-auto text-center'>
        ...
        <footer className='flex justify-center items-center w-full px-4 py-2'>
          <p className='text-center text-gray-500'>
            Made with <span className='text-red-500'>❤</span> by <a href='http://github.com/evertcode' className='text-blue-500 hover:text-blue-400 hover:shadow-xl hover:' target='_blank' rel='noopener noreferrer'>evertcode</a>.
          </p>
        </footer>
      </main>
    </div>
